  ...
  return (
    <div className='w-full rounded-xl border border-gray-300 bg-white p-6 shadow-lg lg:rounded-2xl lg:p-15'>
      ...
      <div className='mb-6 lg:mb-8'>
        ...
        {/* 서브타이틀 */}
        <div className='ml-0 flex items-center gap-2 lg:ml-20 lg:gap-3'>
      ...
      <div className='space-y-6 lg:space-y-6'>
        ...
        <div className='space-y-3 lg:space-y-4'>
          <div className='flex items-center gap-3'>
            <div className='flex h-8 w-8 items-center justify-center rounded-full bg-gray-50 lg:h-10 lg:w-10'>
              <MapPin className='h-4 w-4 text-gray-600 lg:h-5 lg:w-5' />
            </div>
            <h3 className='text-xl font-semibold text-gray-800 lg:text-[2rem]'>
              주소 / Address
            </h3>
          </div>
          <div className='ml-11 space-y-1 text-sm leading-relaxed text-gray-700 lg:ml-13 lg:text-[2rem]'>
        ...
        <div className='space-y-3 lg:space-y-4'>
          <div className='flex items-center gap-3'>
            <div className='flex h-8 w-8 items-center justify-center rounded-full bg-gray-50 lg:h-10 lg:w-10'>
              <Mail className='h-4 w-4 text-gray-600 lg:h-5 lg:w-5' />
            </div>
            <h3 className='text-xl font-semibold text-gray-800 lg:text-[2rem]'>
              연락처 / Contact
            </h3>
